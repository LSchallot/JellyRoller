...
pub fn command_list_users(cfg: AppConfig, export: bool, mut output: String, username: String, users_endpoint: &str, user_id_endpoint: &str) {
...
pub fn command_reset_password(cfg: AppConfig, username: String, password: String, users_endpoint: &str) {
    // Get usename
    let user_id = UserList::get_user_id(
        UserList::new(users_endpoint, &cfg.server_url, &cfg.api_key),
        &username,
...
pub fn command_disable_user(cfg: AppConfig, username: String, user_policy_endpoint: &str, user_id_endpoint: &str) {
    modify_user(cfg, username, user_policy_endpoint, user_id_endpoint, UserMods::Active, false);
}

pub fn command_enable_user(cfg: AppConfig, username: String, user_policy_endpoint: &str, user_id_endpoint: &str) {
    modify_user(cfg, username, user_policy_endpoint, user_id_endpoint, UserMods::Active, true);
}

pub fn command_grant_admin(cfg: AppConfig, username: String, user_policy_endpoint: &str, user_id_endpoint: &str) {
    modify_user(cfg, username, user_policy_endpoint, user_id_endpoint, UserMods::Admin, true);
}

pub fn command_revoke_admin(cfg: AppConfig, username: String, user_policy_endpoint: &str, user_id_endpoint: &str) {
...
pub fn command_remove_device_by_username(cfg: AppConfig, username: String, devices_endpoint: &str) {
...
///
fn gather_user_information(cfg: &AppConfig, username: &String, id: &str, user_id: &str) -> UserDetails {
...
/// 
fn modify_user(cfg: AppConfig, username: String, user_policy_endpoint: &str, user_id_endpoint: &str, mod_type: UserMods, mod_flag: bool) {
